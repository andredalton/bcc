...
/*???????????????????????????????????????????????????????????????????????*/
/*???????????????????????????????????????????????????????????????????????*/
#define GET_SEM        31 /* Requisicao para um novo semaforo.           */
#define P_SEM          32 /* Operação P do semaforo.                     */
/*???????????????????????????????????????????????????????????????????????*/
/*???????????????????????????????????????????????????????????????????????*/
#define ACCESS		  33
/*???????????????????????????????????????????????????????????????????????*/
/*???????????????????????????????????????????????????????????????????????*/
#define V_SEM        34 /* Operação V do semaforo.                       */
#define FREE_SEM     35 /* Liberacao de um semaforo.                     */
/*???????????????????????????????????????????????????????????????????????*/
/*???????????????????????????????????????????????????????????????????????*/
#define SYNC		  36 
#define KILL		  37
...
/*???????????????????????????????????????????????????????????????????????*/
/*???????????????????????????????????????????????????????????????????????*/
#define WAIT_SEM      44 /* Aguarda que descendentes liberem o semaforo. */
/*???????????????????????????????????????????????????????????????????????*/
/*???????????????????????????????????????????????????????????????????????*/
#define SYMLINK		  45
#define SETGID		  46
