...
_PROTOTYPE (int (*call_vec[]), (void) ) = {
	...
	/*????????????????????????????????????????????????*/
	/*????????????????????????????????????????????????*/
	do_get_sem,	/* 31 = acesso a novo semaforo.       */
	do_p_sem,   /* 32 = funcao P do semaforo.         */
	/*????????????????????????????????????????????????*/
	/*????????????????????????????????????????????????*/
	...
	/*????????????????????????????????????????????????*/
	/*????????????????????????????????????????????????*/
	do_v_sem,	   /* 34 = funcao V do semaforo.      */
	do_free_sem,   /* 35 = funcao free do semaforo.   */
	/*????????????????????????????????????????????????*/
	/*????????????????????????????????????????????????*/
	...
	/*????????????????????????????????????????????????*/
	/*????????????????????????????????????????????????*/
	do_wait_sem,      /* 44 = funcao wait do semaforo.*/
	/*????????????????????????????????????????????????*/
	/*????????????????????????????????????????????????*/
