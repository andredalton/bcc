...
/* Função que calcula um tempo aleatório que tem valor minimo de min e máximo
 * de max.
 ****************************************************************************/
...
/* Para esta função o tipo de terreno também deve ser passado como parametro 
 * de entrada.
 ***************************************************************************/
...
/* Para esta função é preciso especificar o numero da transicao no segundo
 * parametro.
 *************************************************************************/
