...
DELIMITER $1
DROP TABLE IF EXISTS `estado`$1
CREATE TABLE `estado` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `nome` varchar(255) NOT NULL,
  `sigla` char(2) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8$1

--
-- Table structure for table `fabricante`
--
DELIMITER $2
DROP TABLE IF EXISTS `fabricante`$2
CREATE TABLE `fabricante` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8$2
